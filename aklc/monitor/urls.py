...
urlpatterns = [
    ...
    path("node/mqttlog/<int:node_ref>/<int:mq_ref>/", views.nodeMqttLog, name="nodeMqttLog"),
    path("gateway/mqttlog/<int:gateway_ref>/<int:mq_ref>/", views.gatewayMqttLog, name="gatewayMqttLog"),
